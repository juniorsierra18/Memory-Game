...
func SixteenCards(w fyne.Window) {
	...
	grid := container.NewGridWithColumns(4,
		container.NewVBox(carta1, carta5, carta9, carta13),
		container.NewVBox(carta2, carta6, carta10, carta14),
		container.NewVBox(carta3, carta7, carta11, carta15),
		container.NewVBox(carta4, carta8, carta12, carta16),
	)
