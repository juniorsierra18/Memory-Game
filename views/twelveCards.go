...
func TwelveCards(w fyne.Window) {
	...
	grid := container.NewGridWithColumns(4,
		container.NewVBox(carta1, carta5, carta9),
		container.NewVBox(carta2, carta6, carta10),
		container.NewVBox(carta3, carta7, carta11),
		container.NewVBox(carta4, carta8, carta12),
	)
